const ThingToWinSecond = () => {
  return (
    <div className="reveal-up reveal-repeat delay-250 mt-12 h-30 group relative p-8 rounded-2xl bg-[#0f172a]/50 border backdrop-blur-sm border-blue-500/50 shadow-xl">
